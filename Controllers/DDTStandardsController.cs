...
public class DDTStandardsController : Controller
{
    ...
    /// <summary>
    /// Display all published DDT standards
    /// </summary>
    public async Task<IActionResult> Index(string? search, string? category, int page = 1)
    {
        try
        {
            ...
            if (response == null)
            {
                ...
                return View("~/Views/Standards/DDTStandards/Index.cshtml", new DdtStandardsResponse { Data = new List<DdtStandardDto>() });
            }
    ...
    /// <summary>
    /// Display details of a specific DDT standard
    /// </summary>
